...
<div class="multiSelectItem {activeSelectedValue === i ? 'active' : ''} {isDisabled ? 'disabled' : ''}" role="presentation" on:click={event => multiFullItemClearable ? handleClear(i, event) : {}}>
