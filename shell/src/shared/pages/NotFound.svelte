        ...
        <div class="max-w-lg">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2395 1800" class="w-full max-w-sm" width="400">
            ...
            <path
              ...
              stroke="#000"
              fill="#d6b49a"></path>
            <ellipse cx="748.2" cy="816.89" rx="202.22" ry="30.98" transform="rotate(-19.91 748.327 816.983)" stroke-miterlimit="10" fill="#020202" stroke-width="3" stroke="#000"></ellipse>
            <path
              class="cls-3"
            ...
            ></path>
            <path class="cls-5" d="M583.29 1375.5H583s-8.5-.11-16.44-7.73c-6.25-6-.85-32.43 18-63.08 16.1 31.14 20.08 57.13 14.16 63.08-7.6 7.69-15.43 7.73-15.43 7.73z"></path>
            <path
              class="cls-7"
            ...
            <path class="cls-7" d="M1530.83 851.27l119.81-98a13.73 13.73 0 0122.29 8.61c3.24 22.58 4.13 45.46 4.35 81S1665 911 1656.5 964.5a284.8 284.8 0 00-125.67-113.23z"></path>
            ...
            <path class="cls-10" d="M1445.26 997.13l10.24 1.37 9.39-1.34a2.14 2.14 0 012.11 3.27l-9.09 14.28a3 3 0 01-4.94.08l-9.77-14.33a2.15 2.15 0 012.06-3.33z"></path>
            <path class="cls-13" d="M1454.74 1016.08s2.76 17.42-17.24 15.42M1455.63 1017.08s-2.76 17.42 17.24 15.42"></path>
            <path class="cls-14" d="M1664.5 1001.5L1735 980M1667 1017l66.5 10.5M1244 1017l-60.5 13.5M1246.5 1000.5L1180 990"></path>
            <path
              class="cls-15"
            ...
            <path
              class="cls-15"
              d="M823.54 819.3c-17.76-23.9-59.56-97.14-83.92-120.77a597.13 597.13 0 00-166.5-113.78l-22.31 8.44a635.18 635.18 0 01182.77 131.33c17.7 18.29 54.44 85.77 68.42 104z"></path>
            <path
              class="cls-7"
            ...
            ></path>
            <path class="cls-15" d="M857.63 805c2.87-1.5-27.13-292.5-111.13-404.5s-104-130-104-130-2 85 34 145 78 160 90 182 56 223 56 223z"></path>
          </svg>
        </div>
      </div>
    </div>
